...
class AppIcons {
  ...
  static const IconData busStop = Icons.hail_rounded;
  ...
  static const IconData driver = Icons.engineering_rounded;
  static const IconData passenger = Icons.person_pin_rounded;
  ...
  static const IconData chart = Icons.insert_chart_rounded;
  ...
  static const IconData approve = Icons.check_rounded;
  static const IconData reject = Icons.close_rounded;
  ...
  static const IconData distance = Icons.straighten_rounded;
  static const IconData passengers = Icons.people_outline_rounded;
  static const IconData capacity = Icons.event_seat_rounded;
  ...
  static const IconData update = Icons.system_update_rounded;
  ...
  static Widget themedIcon(
    ...
    return Icon(
      icon,
      size: size ?? 24,
      color: color ?? getIconColor(context, isSelected: isSelected),
    );
  }
}
