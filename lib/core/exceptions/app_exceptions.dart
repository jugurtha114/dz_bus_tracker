...
class ApiException extends AppException {
  ...
  factory ApiException.badRequest(String message, {Map<String, dynamic>? details}) => ApiException(
    message,
    code: 'BAD_REQUEST',
    statusCode: 400,
    details: details,
...
class ValidationException extends AppException {
  ...
  factory ValidationException.invalidFormat(String field, String format) => ValidationException(
