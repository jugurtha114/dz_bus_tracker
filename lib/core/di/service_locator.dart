...
Future<void> setupLocator() async {
  ...
  try {
    // Register AuthStateProvider as singleton for DI consistency
    sl.registerLazySingleton<AuthStateProvider>(() => AuthStateProvider.instance);
    Log.d("AuthStateProvider registered in service locator");
  } catch (e) {
    Log.w("Failed to register AuthStateProvider", error: e);
    // This is non-fatal as the provider is accessible as a static instance
  }
